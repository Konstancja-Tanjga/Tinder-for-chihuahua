...
Specyfikacja z `design/tokens.json`: **752×660**, 3–5 s,
24 fps, bez sciezki audio, petla plynna (boomerang), budzet 900 kB.
...
| `kwiatuch.mp4` | `Kwiatuch.mp4` | wygenerowane AI (Grok), wlasnosc autorki | brak osob trzecich | zgodne | 552 kB, crf 26 |
...
**Ciastek** (`ciastek.mp4`, krop 340×298×110×79, domyslny) — Kadrowanie domyslne (55% wysokosci, srodek w 42%). Nie mierzone z siatki -- warto obejrzec.

**Fistaszek** (`fistaszka.mp4`, krop 280×246×186×64, mierzony) — Plik nazwany w dopelniaczu; imie w aplikacji w mianowniku. Glowa zajmowala 27% szerokosci, wiec krop ciasny i skalowanie 2,7x.

**Kwiatuch** (`kwiatuch.mp4`, krop 400×352×40×93, domyslny) — Kadrowanie domyslne (55% wysokosci, srodek w 42%). Nie mierzone z siatki -- warto obejrzec.

**Lola** (`lola.mp4`, krop 340×298×10×50, mierzony) — Kadr od 7,2 s -- wczesniej w ujeciu jest ludzka reka, czego specyfikacja zabrania.
...
**Skowronek** (`skowronek.mp4`, krop 340×298×32×81, mierzony) — Czerwony sweterek w kadrze -- czerwien nie niesie tu znaczenia, wiec CIG-2.2 nie jest naruszone.
