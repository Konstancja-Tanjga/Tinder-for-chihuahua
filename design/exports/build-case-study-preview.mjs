...
const CHAPTERS = [
  ...
  { n: '09', slug: 'design-system', title: 'Design system i tokeny',
    what: 'Paleta, typografia i dwie skale — dog scale i human scale.',
    why: 'To najważniejsza decyzja architektury systemu i nie ma jej w żadnym gotowym design systemie.',
    look: 'Na #0033FF i #D6F000 — obie barwy leżą blisko szczytów czułości psich czopków.' },
